...
import 'schema/prayer_month_record.dart';
...
export 'schema/prayer_month_record.dart';
...
Stream<List<PrayerMonthRecord>> queryPrayerMonthRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(PrayerMonthRecord.collection, PrayerMonthRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
